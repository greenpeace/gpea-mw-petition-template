		...
		<>
			{type === 'support' && (
				<Box pt={6} color={'white'}>
					...
					<Text as="p" {...paragraphProps}>
						...
						<br />
						卻不如其他零售企業嘗試減塑、重複使用模式，因此綠色和平邀請您一起要求全聯：
					</Text>

					<UnorderedList>
						<ListItem>發展裸賣、自備容器填裝、可歸還包裝的替代方案</ListItem>
						<ListItem>
							投入消費者溝通，促進消費者了解並參與減塑行動，並定期向大眾公開減量成效
						</ListItem>
					</UnorderedList>
				</Box>
			)}
			{type === 'subscribe' && (
				<Box pt={6}>
					...
					<Text as="p" {...paragraphProps}>
						若維持目前使用塑膠的習慣、缺乏積極減塑作為，2040
						年流入海洋的塑膠垃圾量將是現今的 3
						倍！我們必須爭取時間加速減塑，避免海洋塑膠悲劇持續擴大。
						<br />
						綠色和平曾成功推進臺灣減塑：
					</Text>
					...
					<UnorderedList>
						<ListItem>
							經長期向零售企業倡議，全家便利商店宣布大規模導入循環杯至 400
							家門市
						</ListItem>
						<ListItem>
							發起「絕塑好店計畫」，選定臺中草悟道商圈作為循環杯示範商圈，並在 3
							個月內於商圈內減少了超過 1600 個一次性飲料杯
						</ListItem>
						<ListItem>
