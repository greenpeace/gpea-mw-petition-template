...
import Form from './Form/StreamingForm';
...
function Index() {
	...
	return (
		<>
			...
			<Box
				pos={'relative'}
				backgroundImage={{ base: DesktopHero }}
		...
		<div className="relative w-full bg-black ">
			<Box pos={'relative'} zIndex="2">
              ...
              />
						...
						<p
							className="whitespace-pre-wrap text-[16px] leading-relaxed"
							dangerouslySetInnerHTML={{ __html: Translation[language]['p5'] }}
						/>
						<Link
							href="https://cloud.greentw.greenpeace.org/donation-cwf-seafood-handbook"
							isExternal
						>
							<Button
								{...OrangeCTA}
