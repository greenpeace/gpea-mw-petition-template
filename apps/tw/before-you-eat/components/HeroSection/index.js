			...
			>
				...
				>
					<div className="flex flex-col gap-4 md:flex-1">
						...
						<p className="text-[18px] font-medium">歷時大半年製作的生態盛會</p>

						<div className="font-medium leading-loose md:max-w-[460px]">
							<span className="mr-2 inline-block">片長：25分鐘</span>
							<span className="mr-2 inline-block">編導：馮漢城</span>
							<span className="mr-2 inline-block">聲音導航：陳志雲</span>
						</div>
