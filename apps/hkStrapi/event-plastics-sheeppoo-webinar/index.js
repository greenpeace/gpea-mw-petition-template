...
PROJECT=hkStrapi/event-plastics-sheeppoo-webinar
MARKET=hk
PROJECT_NAME=event-plastics-sheeppoo-webinar
BASEPATH=/web/api.greenpeace.org.hk/htdocs/page/event-plastics-sheeppoo-webinar
ASSETPREFIX=https://api.greenpeace.org.hk/page/event-plastics-sheeppoo-webinar/
FTP_CONFIG_NAME=api_hk_cloud 
# ******** MC Cloud Page Name ********
CLOUD_PAGE_NAME=event-plastics-sheeppoo-webinar
*/
...
import { Box, Flex, Heading, Avatar, AvatarGroup } from '@chakra-ui/react';
		...
		<>
			...
			<Box>
				{isLoaded && (
                  ...
                  <Avatar
                    name="Wilson Cheung"
                    src={"https://www.greenpeace.org/static/planet4-hongkong-stateless/2023/07/83808bde-202308-sheeppoo-webinar_02-sheeppoo-profile.png"}
                    bgColor={'white'}
                  />
                </AvatarGroup>
							</HeroBanner>
