...
import draw from './images/shutterstock_755012653.jpg';
...
const speaker1Content = [
  {
    ...
    role: '極地科研與探險專家',
    content: `在極地工作10年以上，是首位港產極地科研專家，現時也是極地探險安全顧問。Wilson目前在斯瓦爾巴特群島和加拿大北極研究冰川變化，是位冰川學博士學生和極地文化研究員。他的身分亦包括：南極研究科學委員會（SCAR）人文社會科學專家組成員、國際北極科學委員會成員、首位亞洲PTGA資深極地探險嚮導、英國皇家地理學會成員和美國探索者協會50名最具影響力探險家，以及亞洲青年探險導師計劃創辦人，10多年來致力提高公眾對極地和冰川動態的認識和關注。`,
    avatar: speaker1,
  },
];
