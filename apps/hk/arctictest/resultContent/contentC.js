...
// import image01 from '../images/GP0STTWJ0_Medium_res.jpg';
// import image02 from '../images/GP0STTWIG_Medium_res.jpg';
...
const Content = ({ theme }) => {
  ...
  return (
    <>
      ...
      <Text as="p" {...paragraphProps}>
        從根源解決塑膠污染問題，綠色和平一直以行動、科學研究、倡議等方式，推動企業如超市、連鎖快餐店等淘汰即棄塑膠包裝或器皿，為消費者提供無塑選擇...
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        您的捐款將直接資助我們推動企業淘汰即棄塑膠、督促政府訂立更積極的減塑目標與政策、招募商戶成為走塑店鋪，源頭減少即棄塑膠，減輕環境負擔。
      </Text>
