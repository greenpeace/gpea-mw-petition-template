...
const Content = ({ theme }) => {
  ...
  return (
    <>
      ...
      <Box {...paragraphProps}>
        綠色和平誠意推出《山海大嶼》電子書，精選大嶼山在環境、生態等方面的內容與珍貴面貌，部分內容由守護大嶼行動者、得獎攝影團隊用心撰寫、提供，呈現了大嶼山鮮為人知卻又彌足珍貴的資訊。透過閱讀此書，我們希望同熱愛這片土地的您，能進一步了解並守護大嶼山生態，免受「明日大嶼」填海項目破壞。電子書內容包括：
      </Box>
      ...
      <Box {...paragraphProps}>
        綠色和平藉由《山海大嶼》電子書，集合大嶼環境、行山、生態等眾多資訊與照片，務求令大眾更全面了解這片屬於香港的「後花園」，從而加入守護行列，免它遭受更多基建工程嚴重破壞。《山海大嶼》是香港人不可錯過的大嶼山主題特刊，請即下載了解。
      </Box>
