  ...
  return (
    <>
      ...
      <Text as="p" {...paragraphProps}>
        2020 年香港即棄膠餐具棄置量達歷史新高的每日 266 公噸；管制即棄膠餐具，刻不容緩。
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        2021 年，當局為管制即棄膠餐具作公眾諮詢，綠色和平聯合 10 個環團動員超過 5,400 名公眾遞交意見書，有賴您我積極發聲，終促使政府正式提出立法建議。
      </Text>

      <Text as="p" {...paragraphProps}>
        2018 年，當局開展「土地大辯論」公眾諮詢，超過 50,000 名熱心市民透過綠色和平聯署頁提交意見書；最終「發展棕地」被納入為短中期的優先項目。
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        事實上，各地早已有立法限塑先例可循，其政策均有確實時間表與分段目標：以歐盟為例，2019 年便發佈「管制塑膠條例」，禁止銷售及派發餐具、棉花棒、飲管等即棄塑膠用品；鄰近的中國內地及澳門亦已禁止餐飲業提供膠飲管，並已經禁止售賣及生產發泡膠餐具。
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        除了全面管制即棄膠餐具，發展可重用系統同樣重要。綠色和平經過 3 年推動，亦為消費者帶來無塑選擇的成果：綠色和平台北辦公室成功爭取政府立法規管連鎖便利商店、超市等為自備容器的消費者提供優惠及必須提供循環杯租借服務，推算若有 10% 消費者不使用即棄杯，一年就能省下 100 萬個杯！（在香港，綠色和平亦將於社區試行借還重用杯計劃，希望提供更多走塑方案、加強社區連繫、新的社會環保好習慣。）
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        若政府仍不發展可重用系統，即棄塑膠問題只會依舊存在。管制塑膠與推廣重用必須雙管齊下！請即聯署要求政府在 22/23 年度立法，管制即棄餐具，於 2025 年前落實全面管制，並盡快發展可重用系統！
      </Text>
    </>
  );
};
