...
const SEO = () => {
  return (
    <Head>
      ...
      <meta
        name="description"
        content="家居物品種類繁多，大眾未必清楚知道正確的回收分類與方法。因此，綠色和平特意邀請到回收廠Mil Mill代表，以及環保網店Guruguru創辦人阿晴參與線上講座，講解回收要點、分類與限制，分享業界推廣重用、源頭減廢的工作，以及​​​​大眾能如何做好家居減廢與回收。在講座裡，您可以了解到回收業背後的工序，認識家居減廢的方法。"
      />
      <meta
