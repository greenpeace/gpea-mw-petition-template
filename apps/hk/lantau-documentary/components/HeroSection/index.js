  ...
  return (
    <div className="relative">
      <Box
        ...
        zIndex={10}
      >
        <div className="mx-[10px] md:mx-0 pt-[125px] md:pt-[195px]">
          <Image src={appLogo} m={'auto'} maxW={{base: `${355 - scrollPosition}px`, md: `${1040 - scrollPosition}px`}} />
        </div>
        <Box
        ...
        <div
          className="container mx-auto px-[30px] md:pt-[270px] md:max-w-[1180px] relative"
          style={{ zIndex: 99 }}
        >
