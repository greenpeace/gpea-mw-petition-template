...
const CARDS = [
  ...
  },
  {
    ...
    cate: '潮間帶',
    content:
      '翻石鷸遷徙途中會路徑香港。他們會用鳥喙翻動石頭，尋找底下的蟹類為食',
  },
  {
    image: typec2,
    title: '馬蹄蟹',
    cate: '潮間帶',
    content:
      '馬蹄蟹是一種史前生物，在地球已存活了超過四億年，世代在潮間帶繁殖',
  },
  {
    image: typed1,
    title: '中華白海豚',
  ...
  },
  {
    ...
    cate: '海洋',
    content:
      '大興土木、船隻超速航行等，均會破壞海洋生態，造成不可挽救的影響。',
  },
];
                  ...
                  <div className="bg-[#FFF] shadow-lg rounded-xl" key={`${d.title}-${i}`}>
                    ...
                    <div className="bg-[#FFF] rounded-b-xl">
                      <div className="p-6">
                        ...
                        <p className="text-[16px] font-[400]" dangerouslySetInnerHTML={{__html: d.content}}/>
                      </div>
                    </div>
                  </div>
                ))}
