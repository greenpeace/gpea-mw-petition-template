      ...
      <div className="hidden lg:block">
        <div className="flex flex-row gap-[60px]">
          <div className="flex flex-col gap-[20px]">
            {CATEGORIES.map((d, i) => (
              <div
                className="relative w-[200px] h-[100px] rounded-md overflow-hidden"
                key={`${d.title}-${i}`}
              >
                <Box
                ...
                >
                  <Center
                    className={`ease-linear backdrop-blur-sm hover:backdrop-blur-none ${
                      d.value == active
                    ...
                    zIndex={2}
                  >
                    <p className="hover:font-bold text-[20px] text-[#FFF]">
                      {d.label}
                    </p>
                  </Center>
                </Box>
            ...
            <div className="grid grid-cols-2 gap-8">
              {CARDS.filter((d) => d.cate === active).map((d, i) => (
                ...
                >
                  ...
                  <div className="p-6 bg-[#FFF] rounded-b-[12px]">
