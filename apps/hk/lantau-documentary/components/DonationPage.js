    ...
    <>
      <div className="relative pb-[60px]">
        ...
        <div
          ...
          style={{ zIndex: 11 }}
        >
          <div className="flex flex-col pt-[140px] md:pt-[80px] lg:pt-[200px] pb-[40px] md:py-0">
        ...
        <div
          className="container mx-auto px-[20px] pt-[40px] md:pt-[140px] md:max-w-[1345px] relative"
          style={{ zIndex: 10 }}
        >
          <div className="flex flex-col-reverse lg:flex-row gap-8 relative z-10">
