...
// custom components
import Webinar from '@apps/hk/virtual-tour-around-asia/components/Webinar';
  ...
  return (
    <>
      ...
      <Text as="p" {...paragraphProps}>
        年尾香港有望通關，當很多香港人熱切期待出外旅行之際，
        <Text as="span" fontWeight="bold" textDecoration={'underline'} {...paragraphProps}>
          是次活動特別邀請綠色和平香港、台北、首爾、東京辦公室的代表，實時與我們連線，剖析各地環保工作的甜酸苦辣，更會分享他們一手拍攝的照片、影片
        </Text>
        ，讓您了解，您我即使身在香港，也能參與具國際影響力的環保行動！
      </Text>
      ...
      <Text as="p" {...paragraphProps}>
        而香港辦公室身為綠色和平東亞分部的一員，其實同時連繫東亞其他團隊，結合彼此的專業範疇與資源，推動更大環保成果。
        <Text as="span" fontWeight="bold" textDecoration={'underline'} {...paragraphProps}>
          立即報名網上分享會，實時連線港台日韓四地，眼睛去旅行之餘，了解最新環保熱話！
        </Text>
      </Text>
