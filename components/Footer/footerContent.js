...
export const TWChinese = {
  ...
  rightContent: [
    ...
    '財團法人綠色和平基金會<br/>統一編號：26324671<br/>勸募活動許可文號：衛部救字第1131363009號<br/>環署綜字第1000044076號',
  ],
};
...
export const Korean = {
  ...
  rightContent: [
    ...
    '기타 문의는 FAQ 참고 부탁드립니다. 또한 후원관리팀으로 이메일 <a href="mailto:help.kr@greenpeace.org">help.kr@greenpeace.org</a> 또는 유선 문의 주세요. <a href="tel:+82231441997">02-3144-1997</a> (평일 오전 10시~오후 5시)',
  ],
};