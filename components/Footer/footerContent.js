...
export const TWChinese = {
  ...
  rightContent: [
    '此頁面採用了 SSL 保安接層加密技術，可確保敏感資料（例如信用卡資料和個人資料）在您的瀏覽器和我們伺服器之間傳送時獲得保密處理。<br><br>送出資料後，此信用卡捐款將即時進行。每月捐款會員的往後捐款，將於每月 2 日請款；若未能成功請款，有可能是系統或信用卡等出現問題，因此系統將自動重新嘗試，如有需要，會員服務部將會與您聯繫確認。每月捐款將在該信用卡效期到期後與獲發新卡後仍繼續有效，直至捐款人另行通知。',
